<x-app-layout>
    ...
    <div class="bg-white border-3 border-ink shadow-brutal flex flex-col md:flex-row mb-12">
        ...
        <div class="w-full md:w-1/2 p-8 flex flex-col">
            ...
            <!-- Tombol Aksi Beli Besar -->
            <button class="w-full bg-seaweed text-white border-3 border-ink p-4 font-display font-black text-2xl shadow-brutal hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-brutal-hover transition-all flex items-center justify-center gap-3">
